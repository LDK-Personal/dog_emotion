...
img_height = 100
# path for results
model_path="C:\\Users\\owner\\Desktop\\Dog-Emotions-master\\save"
...
# read image csv
data = pd.read_csv('C:\\Users\\owner\\Desktop\\Dog-Emotions-master\\prep_images_rotated.csv')
...
model.save(model_path + 'classifier.keras')
